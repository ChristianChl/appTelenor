...
NzSpaceComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NzSpaceComponent, selectors: [["nz-space"], ["", "nz-space", ""]], contentQueries: function NzSpaceComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, NzSpaceItemLegacyComponent, 0);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NzSpaceItemDirective, 0, TemplateRef);
    } if (rf & 2) {
        let _t;
...
NzSpaceModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[BidiModule, CommonModule]] });
