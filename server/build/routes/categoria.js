...
router.post('/', [
    ...
    express_validator_1.check('cat_descripcion', 'La descripción del producto es obligatorio').not().isEmpty(),
    express_validator_1.check('cat_activo', 'El estado del producto es obligatorio').not().isEmpty(),
    validar_campos_1.validarCampos
], categoriaController_1.postCategoria);
router.put('/:id', categoriaController_1.putCategoria);
